...
typedef bool (*PKTTBL_LoadTbl)(PKTTBL_Tbl* NewTbl); 

/* Table Owner's function to load a single table pkt. The JSON object/container is an array */
typedef bool (*PKTTBL_LoadTblEntry)(uint16 PktIdx, PKTTBL_Pkt* NewPkt);   
...
typedef struct {
   ...
   uint16   CurApId;   /* Most recent ApId processed by the callback function */
