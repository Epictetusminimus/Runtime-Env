...
typedef bool (*TBLMGR_LoadTblFuncPtr) (TBLMGR_Tbl *Tbl, uint8 LoadType, const char* Filename);
typedef bool (*TBLMGR_DumpTblFuncPtr) (TBLMGR_Tbl *Tbl, uint8 DumpType, const char* Filename);
