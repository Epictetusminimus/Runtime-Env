...
typedef bool (*CHILDMGR_CmdFuncPtr) (void* ObjDataPtr, const CFE_SB_Buffer_t* SbBufPtr);
...
typedef bool (*CHILDMGR_TaskCallback) (struct CHILDMGR_Struct* ChildMgr);
...
**
*/
bool CHILDMGR_RegisterFunc(CHILDMGR_Class* ChildMgr,
