...
static bool GetIdBit(STATEREP_Class*    StateRep,
                          ...
                          const CFE_SB_Buffer_t* SbBufPtr)    /* Pointer to STATEREP_ClearBitCmd struct      */
{
   ...
   STATEREP_ClearBitCmdMsg* ClearBitCmd = (STATEREP_ClearBitCmdMsg*)SbBufPtr;
...

{
   ...
   STATEREP_Class* StateRep = (STATEREP_Class*)ObjDataPtr;
   STATEREP_ConfigBitCmdMsg*  ConfigBitCmd = (STATEREP_ConfigBitCmdMsg*)SbBufPtr;
